...
// ******************** All server calls related to /myaccount page *********************
/*
 *  /myaccount: Select USER details from MySQL database
 *  (See https://www.w3schools.com/nodejs/nodejs_mysql.asp)
 */
...
/*
 *  /myaccount: Select deployables for /myaccount on MySQL database
 *  
 */
...
/*
 *  /myaccount: Select environments for /myaccount on MySQL database
 *  
 */
...
console.log(`ABOUT TO REGISTERERE`);

deploymentServices.register(server)
console.log(`AFTERR TO REGISTERERE`);
